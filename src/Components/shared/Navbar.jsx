        ...
        <Link href="/" prefetch onClick={closeAllMenus} className="flex items-center cursor-pointer">
          <div className="flex items-center">
            ...
            <div className="flex flex-col ml-2">
              <span className={`text-blue-950 text-sm italic font-bold tracking-wide ${Playfair.className}`}>BD SHIPS</span>
              <div className="flex items-center">
                <Image
                  src="/l.png"
                  alt="logo"
      ...
      <nav className="flex-1 overflow-y-auto py-4">
        <ul className="space-y-1 px-2">
          ...
          <li>
            <Link
              href="/TANGUAR HAOR"
              className={`flex items-center justify-between py-3 px-4 text-sm hover:bg-blue-50 rounded-lg transition-colors duration-200 group ${isActiveLink("/TANGUAR HAOR")
                ? "bg-blue-50 text-blue-600 font-semibold"
                : "text-[#00026E]"
                }`}
              onClick={closeAllMenus}
            ...
            >
              ...
              <FaChevronRight className={`group-hover:translate-x-1 transition-transform ${isActiveLink("/TANGUAR HAOR") ? "text-blue-600" : "text-blue-400"
                }`} />
            </Link>
          </li>
          ...
          <li>
            <Link
              href="/TUNDARBAN"
              className={`flex items-center justify-between py-3 px-4 text-sm hover:bg-blue-50 rounded-lg transition-colors duration-200 group ${isActiveLink("/TUNDARBAN")
                ? "bg-blue-50 text-blue-600 font-semibold"
                : "text-[#00026E]"
                }`}
              onClick={closeAllMenus}
            ...
            >
              ...
              <FaChevronRight className={`group-hover:translate-x-1 transition-transform ${isActiveLink("/TUNDARBAN") ? "text-blue-600" : "text-blue-400"
                }`} />
            </Link>
          </li>
          ...
          <li>
            <Link
              href="/SAINT MARTIN"
              className={`flex items-center justify-between py-3 px-4 text-sm hover:bg-blue-50 rounded-lg transition-colors duration-200 group ${isActiveLink("/SAINT MARTIN")
                ? "bg-blue-50 text-blue-600 font-semibold"
                : "text-[#00026E]"
                }`}
              onClick={closeAllMenus}
            ...
            >
              ...
              <FaChevronRight className={`group-hover:translate-x-1 transition-transform ${isActiveLink("/SAINT MARTIN") ? "text-blue-600" : "text-blue-400"
                }`} />
            </Link>
          </li>
...
const BookMeHeader = () => {
  ...
  return (
    <header className={`header-area-three shadow-md  md:bg-transparent ${roboto.className} `}>
      <div className="main-header h-18 w-full   ">
          ...
          <div className="container w-[95%] lg:w-[86%] mx-auto">
            <div className="flex justify-between items-center py-2">
              ...
              <div className="hidden ml-10 lg:flex items-center gap-6">
                ...
                <Link
                  href="/TANGUAR HAOR"
                  className={`text-sm font-semibold transition-colors duration-200 ${isActiveLink("/TANGUAR HAOR")
                ...
                <Link
                  href="/TUNDARBAN"
                  className={`text-sm font-semibold transition-colors duration-200 ${isActiveLink("/TUNDARBAN")
                    ? "text-blue-950 border-b-2 border-red-100"
                    : "hover:text-blue-950 text-blue-950"
                    }`}
                  prefetch
                ...
                <Link
                  href="/SAINT MARTIN"
                  className={`text-sm font-semibold transition-colors duration-200 ${isActiveLink("/SAINT MARTIN")
                    ? "text-blue-950 border-b-2 border-red-100"
                    : "hover:text-blue-950 text-blue-950"
                    }`}
                  prefetch
